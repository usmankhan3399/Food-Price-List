...
//   import vgimage from "../images/vegetableimage.png";
    ...
    return (
      <>
        ...
        <div className="categorydiv">
            <NavLink to="/UserPendingComplaints" style={{ textDecoration: "none", flex: 1 }}>
              <Button className="vegetablebtn" active block color="success">
                {/* <img className="img1" src={vgimage} /> */}
               PENDING COMPLAINTS
              </Button>
            </NavLink>
            <Link to="/UserResolvedComplaints" style={{ textDecoration: "none", flex: 1 }}>
  ...
  export default UserComplaintButton;
